// src/components/entregas/menuentregas.js
...
const ITEMS = [
  { label: 'Gestión de Entregas', to: '/app/entregas/gestion', icon: FaTruck,   desc: 'Crea y administra entregas a clientes.' },
  { label: 'Detalle de Entregas', to: '/app/entregas/detalle', icon: FaListAlt, desc: 'Historial y estados de entrega.' },
];
  ...
  return (
    ...
    >
      <Box w="100%" maxW="1100px" textAlign="center">
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 2 }} spacing={6} justifyItems="center">
