// src/components/Ventas/Menuventas.js
...
import { FaUserAlt, FaClipboardList, FaFileInvoice } from 'react-icons/fa';

const ITEMS = [
  { label: 'Clientes', to: '/app/ventas/clientes', icon: FaUserAlt,       desc: 'Gestión de clientes y datos de contacto.' },
  { label: 'Pedidos',  to: '/app/ventas/pedidos',  icon: FaClipboardList, desc: 'Creación, seguimiento y control de pedidos.' },
  { label: 'Factura',  to: '/app/ventas/factura',  icon: FaFileInvoice,   desc: 'Facturación y emisión de comprobantes.' },
];
